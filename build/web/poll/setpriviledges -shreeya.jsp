...
<html>
    ...
    <body>
     ...
     <div id="select"  style="display: block"> 
        ...
        <img class="ui medium circular image" src="../images/stud.png" align="left"    > 
    
    
        <img class="ui medium circular image" src="../images/fac.png" align="right"  >
