...
/*create heading*/
    ...
    <body>
        ...
        <div class="container-fluid bg-info" style="background-color: white; height: 100%; position: relative;top: 100px;">
           <br> <br> <div class="focus" style="position: relative;left:100px"> 
...
<div id="p1" style="display: none">
             ...
             OPTION-10<input type="text" name="option" id="fop10"><br/>
              <input type="submit" value="CREATE" id="pollcreate" required style="height: 100px">
                           </form>
                  </div>
