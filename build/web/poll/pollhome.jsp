...
#b8{
    ...
    <body>
        ...
        <a href="createpoll.jsp">
                <button id="b6" class="ui massive inverted violet button" value="Show Div"  >
                <span class="visible content">Create Poll</span>
                <span class="hidden content"><i class="write icon"></i></span>
                </button>
            </a>
        
        &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="../VotePollController">
                <button id="b7" class="ui massive inverted green button" value="Show Div"  >
                <span class="visible content">Vote Now </span>
                <span class="hidden content"><i class="bar chart icon"></i></span>
                </button>
            </a>
       
         &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="../ViewMyPoll">
                <button id="b8"  class="ui massive inverted red button" value="Show Div"  >
                <span class="visible content">My Polls</span>
                <span class="hidden content"><i class="user icon"></i></span>
                </button>
            </a>
