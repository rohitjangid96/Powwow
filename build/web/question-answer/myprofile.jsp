...
<body class="profile-page">
				                    ...
				                    <div class="tab-content gallery">
										...
										<div class="col-md-12">
										 <div class="card card-content" style="text-align: left;">
						                    <div class="category" style="margin-top: 15px;margin-left: 20px;"><a href="" style="color: #0099cc;"><%="You"%></a> asked in 
										 ...
										 <div class="card card-content" style="text-align: left;">
						                    <div class="category" style="margin-top: 15px;margin-left: 20px;"><a href="../GoToUserProfile?id=<%= qm.getUid() %>" style="color: #0099cc;"> <%= qm.getUname() %></a> asked in 
						                        ...
						                        <%}%>
                                                                        ...
                                                                        <h3 style="margin-top: 10px;margin-bottom: 5px;margin-left: 20px; font-weight: bold;"><a href="../QuestionForYou?id=<%=i%>" style="color: black;"><%= qm.getQue() %></a></h3>
						            		...
						            		<div class="row" style="padding-left: 5px;">
						            			...
						            			<div class="col-md-11 col-sm-11" style="padding-left: 1px;">
                                                                                    <a href="" style="color: #0099cc;"> <%= "You" %></a> answered
    ...
    <option value="16">Swaranjali</option>
    <option value="17">Hostel</option>
    <option value="18">Transportation</option>
    <option value="19">Umang</option>
    <option value="20">Canteen</option>
    <option value="21">Powwow</option>
    <option value="22">Others</option>
        ...
        <input type="button" class="btn btn-info btn-sm" value="Post Blog" onclick="postBlog()"/>
										...
										<div class="col-md-12">
										 <div class="card card-content" style="text-align: left;">
						                    <div class="category" style="margin-top: 15px;margin-left: 20px;"><a href="" style="color: #0099cc;"> <%= "You" %> </a>wrote in 
