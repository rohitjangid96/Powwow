...
<script src="../question-answer/new css js/dashboard/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="../question-answer/new css js/dashboard/js/material.min.js" type="text/javascript"></script>

	<!--  Charts Plugin -->
	<script src="../question-answer/new css js/dashboard/js/chartist.min.js"></script>

	<!--  Notifications Plugin    -->
	<script src="../question-answer/new css js/dashboard/js/bootstrap-notify.js"></script>

	<!-- Material Dashboard javascript methods -->
	<script src="../question-answer/new css js/dashboard/js/material-dashboard.js"></script>
