...
/*             
    ...
    <body>
        ...
        <%
         ...
         <div class="container-fluid bg-info" style="position: relative;background-color: white;margin-top: 50px;margin-left: 60px; ">
            <div class="modal-dialog" style="position: relative; left: 100px;width:1000px; ">
                <div class="modal-content">
         <div class="modal-header">
            <h1 align="center" style=" font-size: 48px"><%=subject%></h1>
        </div>
        ...
        <div class="modal-body" style="min-height:  200px;">
         ...
         <img src="<%="../BookImageLoader?bcover="+bm.getBookcover()%>" style="height: 380px; width: 300px">
          ...
          <div id="namerating">
              <br/>
             <b style=" font-size: 32px"><%=bm.getBookname()%></b><br/><br/>

             <div style="font-size:20px;">Written by   :&nbsp;&nbsp;&nbsp;&nbsp; <b style="color: red;  font-size: 28px"> <%=bm.getBookauthor()%></b></div>
   ...
   <br/><br/>  <b style='font-size: 24px'>Your Rating </b>
               ...
               <div id="desc" style="font-size: 20px; color: black;">
                     <br/>
                     Description :<br/><br/>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <%=bm.getBookdesc()%>
