...
<!--                
        ...
        <div id="notshow1" style="display: none">
             ...
             Branch<input type="text" name="branch" id="t5">
             Semester<input type="text" name="sem" id="t6">
             section<input type="text" name="sec" id="t7">
           ...
           <script>
               ...
               {   
                   ...
                   document.getElementById("t5").value=inp4;
                    ...
                    document.getElementById("l6").focus();
                       document.getElementById("l6").select();
                } 
