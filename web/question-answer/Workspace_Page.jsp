...
<!--<link rel="stylesheet" href="//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css">-->
    ...
    <!-- Bootstrap core CSS -->
    <link href="new css js/MDB Free/css/bootstrap.min.css" rel="stylesheet">

    <!-- Material Design Bootstrap -->
    <link href="new css js/MDB Free/css/mdb.min.css" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="../MyFeed">Home <span class="sr-only">(current)</span></a>
                    </li>
                 
                    <li class="nav-item">
                        <a class="nav-link" href="../about us/aboutus.jsp">About Us</a>
                    </li>
                </ul>
                ...
                <div class="full-bg-img flex-center">
                    <div class="animated fadeIn col-md-12">
                        <div class="row" style="margin-top: 40px;">
                        	...
                        	<div class="col-md-3 ">
                                    <img class="rounded-circle" src="imagesdomain/<%= dcm.getImagePath() %>" alt="Generic placeholder image" style="width: 200px; height: 200px">
                           	</div>
                           	<div class="col-md-3 ml-5">
			                    <ul class="animated fadeIn col-md-12">
			                        <li>
			                            <h1 class="h1-responsive lead" style="font-weight: bold;"><%= dcm.getDname() %> </h1>
			                        </li>
			                        <li>
			                        ...
			                        <li>
                                                    <input type="button" class="btn btn-info btn-nm" id="followbtn" onclick="follow(<%=dcm.getDid()%>)" >
                    		...
                    		<div class="col-md-3">
                    			<ul class="animated fadeIn col-md-12">
			                        <li>
			                            <h2 class="h2-responsive" style="margin-top: 15px;"><i class="fa fa-bookmark"></i> Top Users </h2>
			                        </li>
			                        <li>
			                        	<br>
                                                        <%
...
<main>
    <!--Content-->
    <div class="container">
        <%if(dcm.getAlqm()!=null){int i=0; for(QuestionModel qm: dcm.getAlqm()){qm.setdName(dcm.getDname()); %>
        <div class="row mb-2">
            <!--First columnn-->
            <div class="col-lg-12">
                <!--Card-->
                <div class="card wow fadeIn" data-wow-delay="0.2s">
                    <div class="card-block">
	                    <a href="" style="color: #0099cc;"><%= qm.getUname() %></a> asked in 
	                   	<label class="badge blue"><a href="" style="color: #FFFFFF;"> <%= dcm.getDname() %></a></label> with 
	                       <%for(String tags: qm.getTags()){%>
                                <label class="badge" style="background-color: #ff5d00;"><%=tags%></label>
	                        <%}%>
	            		
	                        <h3 style="margin-top: 5px;margin-bottom: 5px;font-weight: bold;"><%=qm.getQue()%></h3>
	            		...
	            		<div class="row" style="padding-left: 5px;">
	            			...
	            			<div class="col-md-11 col-sm-11" style="padding-left: 1px;">
	            				...
	            				<a class="read" onclick="show('ans<%=i%>','read<%=i%>')" href="../AllAnswer?id=<%=i%>">Read more</a>
...
//                                                console.log(htmlcontent);
    ...
    <!-- Bootstrap tooltips -->
    <script type="text/javascript" src="new css js/MDB Free/js/tether.min.js"></script>

    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="new css js/MDB Free/js/bootstrap.min.js"></script>

    <!-- MDB core JavaScript -->
    <script type="text/javascript" src="new css js/MDB Free/js/mdb.min.js"></script>
    <script type="text/javascript" src="new css js/MDB Free/js/limittext.js"></script>
    <script>
    new WOW().init();
    $('.carousel').carousel({
  interval: 4000
